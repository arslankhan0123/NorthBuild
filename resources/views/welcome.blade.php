        ...
        <div class="swiper hero-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide tj-slider-item">
                    <div class="slider-bg-image" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-1.webp"></div>
                    <div class="container">
                ...
                <div class="swiper-slide tj-slider-item">
                    <div class="slider-bg-image" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-2.webp"></div>
                    <div class="container">
                        <div class="slider-wrapper">
                            <div class="slider-content">
                ...
                <div class="swiper-slide tj-slider-item">
                    <div class="slider-bg-image" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-3.webp"></div>
                    <div class="container">
                        <div class="slider-wrapper">
                            <div class="slider-content">
        ...
        <div class="swiper hero-thumb wow fadeIn" data-wow-delay="2s">
            <div class="swiper-wrapper">
                <div class="swiper-slide thumb-item">
                    <img src="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-thumb-1.webp" alt="Thumbnail">
                </div>
                <div class="swiper-slide thumb-item">
                    <img src="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-thumb-2.webp" alt="Thumbnail">
                </div>
                <div class="swiper-slide thumb-item">
                    <img src="https://themejunction.net/html/bexon/demo/assets/images/hero/slider-thumb-3.webp" alt="Thumbnail">
                </div>
            </div>
        </div>
            ...
            <div class="row row-gap-4">
                ...
                <div class="col-lg-8 col-sm-12 order-lg-2 order-1">
                    <div class="about-content-area-2 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="video-img wow fadeInRight" data-wow-delay=".7s">
                            <img src="https://themejunction.net/html/bexon/demo/assets/images/about/about-3.webp" alt="Image">
                ...
                <div class="col-lg-4 col-md-6 order-lg-3 order-2">
                    <div class="customers-box style-2 wow fadeInUp" data-wow-delay=".3s">
                        <div class="customers-bg" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/about/about-4.webp"></div>
                        <div class="customers">
                            <ul>
                                <li class="wow fadeInLeft" data-wow-delay=".3s"><img src="https://themejunction.net/html/bexon/demo/assets/images/testimonial/client-1.webp"
                                        alt=""></li>
                                <li class="wow fadeInLeft" data-wow-delay=".4s"><img src="https://themejunction.net/html/bexon/demo/assets/images/testimonial/client-2.webp"
                                        alt=""></li>
                                <li class="wow fadeInLeft" data-wow-delay=".5s"><img src="https://themejunction.net/html/bexon/demo/assets/images/testimonial/client-3.webp"
                                        alt=""></li>
                        ...
                        <div class="star-icon zoomInOut"><img src="https://themejunction.net/html/bexon/demo/assets/images/shape/star.svg" alt=""></div>
                    </div>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        <div class="project-img" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/project/project-1.webp"></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        <div class="project-img" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/project/project-4.webp"></div>
                                        <div class="project-content">
                                            <span class="categories"><a href="portfolio-details.html">Business</a></span>
                                            <div class="project-text">
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        <div class="project-img" data-bg-image="https://themejunction.net/html/bexon/demo/assets/images/project/project-5.webp"></div>
                                        <div class="project-content">
                                            <span class="categories"><a href="portfolio-details.html">Business</a></span>
                                            <div class="project-text">
                                                <h3 class="title"><a href="portfolio-details.html">Event Management Platform</a></h3>
                ...
                <div class="col-lg-6">
                    <div class="testimonial-img-area wow fadeInUp" data-wow-delay=".3s">
                        <div class="testimonial-img">
                            <img data-speed=".8" src="https://themejunction.net/html/bexon/demo/assets/images/testimonial/testimonial-img.webp" alt="">
                            <div class="sec-heading style-2">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="sec-heading text-center style-2">
                        ...
                        <h2 class="sec-title text-anim">People Behind <span>Bexon.</span></h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper blog-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="blog-item style-2">
                                        <div class="blog-thumb">
                                            <a href="blog-details.html"><img src="https://themejunction.net/html/bexon/demo/assets/images/blog/blog-4.webp" alt=""></a>
                                            <div class="blog-date">
                                ...
                                <div class="swiper-slide">
                                    <div class="blog-item style-2">
                                        <div class="blog-thumb">
                                            <a href="blog-details.html"><img src="https://themejunction.net/html/bexon/demo/assets/images/blog/blog-5.webp" alt=""></a>
                                            <div class="blog-date">
                                                <span class="date">28</span>
                                                <span class="month">Feb</span>
                                            </div>
